...
class TimeInputScreen(Screen):
    time_input = TextInput(font_size = 50, size_hint_y = None, height = 100, text='-1')
    def __init__(self, **kwargs):
        super(TimeInputScreen, self).__init__(**kwargs)
        ...
        item_layout.add_widget(self.time_input)
    ...
    def on_enter(self, *args):
        self.time_input.text = "0"

    def startNav(self, *args):
        self.time_input.text = "-1"
